...
export interface User { userId: string; name: string; team: string; group: string; score: number; completedChallenges: number[]; attemptedChallengeIds?: number[]; challengeAttempts?: ChallengeAttempt[]; avatarKey?: string; createdAt: string; updatedAt: string; }
...
export interface RankingEntry { rank: number; userId: string; name: string; team: string; group: string; score: number; completed: number; avatarKey?: string; lastActivityAt?: string; }
