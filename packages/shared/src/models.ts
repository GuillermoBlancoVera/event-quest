...
export interface RankingEntry { rank: number; userId: string; name: string; team: string; group: string; score: number; completed: number; avatarKey?: string; affiliation?: Affiliation; parentAffiliation?: Affiliation; lastActivityAt?: string; }
