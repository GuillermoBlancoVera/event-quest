...
export interface CreateMediaUploadRequest { batchId?: string; fileName: string; contentType: string; message?: string; thumbnailContentType?: string; }
export interface CreateMediaUploadResponse { mediaId: string; uploadUrl: string; thumbnailUploadUrl?: string; key: string; uploadedAt: string; }
export interface UpdateMediaRequest { message: string; }
export interface EventMedia { mediaId: string; batchId?: string; authorName: string; message?: string; contentType: string; createdAt: string; url: string; thumbnailUrl?: string; canManage?: boolean; }
