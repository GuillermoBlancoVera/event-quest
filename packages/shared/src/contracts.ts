...
export interface CreateMediaUploadResponse { mediaId: string; uploadUrl: string; thumbnailUploadUrl?: string; displayUploadUrl?: string; key: string; uploadedAt: string; }
